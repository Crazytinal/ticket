    ...
    private void initViews() {
        ...
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(FilmTimeSelectActivity.this, SelectCinemaActivity.class);
            ...
            for (int j = 0; j < filmTimes[0].length; j++) {
                ...
                if (filmTimes[i][j].equals("")) {
                    ...
                    if (r > 2 && r < 7) {
                        ...
                        button.setOnClickListener(new OnClickListener() {
                            public void onClick(View v) {
                                Intent intent = new Intent(FilmTimeSelectActivity.this, FilmSeatsSelectActivity.class);
                                intent.putExtra("filmTimes", filmTimes[n]);
                                intent.putExtra("filmDate", filmDate);
                                intent.putExtra("moviesName", filmNameTextView.getText());
                                intent.putExtra("dianyingyuanname", cinemaNameTextView.getText().toString());
                                intent.putExtra("selecttime", selectTime);
                                intent.putExtra("fangyingting", fangyingting[n]);
