    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LoginActivity.this, SureActivity.class);
                intent.putExtra("dianyingyuanname", getIntent().getStringExtra("dianyingyuanname"));
                intent.putExtra("dizhi", getIntent().getStringExtra("dianyingyuanname"));
                intent.putExtra("fangyingting", getIntent().getStringExtra("fangyingting"));
                intent.putExtra("actionTime", getIntent().getStringExtra("actionTime"));
