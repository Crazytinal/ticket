        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (point != null) {
                ...
                if (t_x > seatsView.x_num + SeatsView.width / 2
                    ...
                    sureButton.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            Intent intent = new Intent(FilmSeatsSelectActivity.this, LoginActivity.class);
                            intent.putExtra("fm", getIntent().getStringExtra("moviesName"));
                            intent.putExtra("dianyingyuanname", getIntent().getStringExtra("dianyingyuanname"));
                            intent.putExtra("fangyingting", getIntent().getStringExtra("fangyingting"));
                            intent.putExtra("actionTime", "2017-05-xx " + ft);
                            intent.putExtra("zuoci", seatStringBuffer.toString());
