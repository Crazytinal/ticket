...
public class SureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yingyuanmingziTextView.setText(getIntent().getStringExtra("dianyingyuanname"));
        ...
        zjTextView.setText(Integer.valueOf(getIntent().getStringExtra("count")) * 20 + "元");
        ...
        sureButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("yingyuanmingzi", getIntent().getStringExtra("dianyingyuanname"));
