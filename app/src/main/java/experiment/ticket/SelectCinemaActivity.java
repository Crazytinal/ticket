...
public class SelectCinemaActivity extends Activity {
    private String[] provinces = {"广东", "浙江"};
    private String[][] cities = { {"广州", "珠海"}, {"杭州", "温州"}};
    private String[][] cinemas = { {"大地影院", "珠海影院"},{"青春电影大世界", "西湖影院"} };
    ...
    private void init() {
        ...
        proviceSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ArrayAdapter<String> areaAdapter1 = new ArrayAdapter<String>(
                        context, android.R.layout.simple_spinner_item, cities[arg2]);
                ...
                citySpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
                            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                                ...
                                cinemaSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
                                            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        sureButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, FilmTimeSelectActivity.class);
